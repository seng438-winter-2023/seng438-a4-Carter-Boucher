...
public class DataUtilitiesTest extends DataUtilities {	
	...
	public void calculateRowTotalWithNegitiveIntegers() throws Exception
	 {
		...
		mock.checking(new Expectations() {
			...
			int columnIndex =  1;
			double answer = calculateRowTotal(array, columnIndex);
			assertEquals("total should be -5", 1, answer, .001);
	...
	public void createNumberArrayZero() {
		...
		assertArrayEquals("Expected array should be [0]", actualArray, actualArray);
	}
	...
	public void create2DNumberArrayZero() {
		...
		assertArrayEquals("Expected array should be [0][0]", actualArray, actualArray);
	}
...
//        //index value for key 2
    ...
    public void testEmptyData() {
        ...
        double result = calculateColumnTotal(data, column, validRows);
    ...
    @Test
    public void testMultipleRowData() {
        Mockery context = new Mockery();
        final Values2D data = context.mock(Values2D.class);
        final int column = 0;
        final int[] validRows = {0, 2};
        context.checking(new Expectations() {{
            oneOf(data).getRowCount(); will(returnValue(3));
            oneOf(data).getValue(0, 0); will(returnValue(1.0));
            ignoring(data).getValue(1, 0);
            oneOf(data).getValue(2, 0); will(returnValue(3.0));
        }});
        double result = calculateColumnTotal(data, column, validRows);
...
//    @Test
//    public void testValidRowsContainsNegativeValue() {
//        Mockery context = new Mockery();
//        final Values2D data = context.mock(Values2D.class);
//        final int column = 0;
//        final int[] validRows = {0, -1, 2};
...
//            assertEquals("The 'validRows' array contains an invalid index: -1", ex.getMessage());
//        }
//        context.assertIsSatisfied();
//    }
    
//    @Test(expected = AssertionError.class)
//    public void testNullDataRow() {
//        Mockery context = new Mockery();
//        final Values2D data = context.mock(Values2D.class);
//        final int column = 0;
//        final int[] validRows = {0, 1, 2};
//        context.checking(new Expectations() {{
//            oneOf(data).getColumnCount(); will(returnValue(0));
//        }});
//        try {
//            calculateRowTotal(data, column, validRows);
//            fail("Expected IllegalArgumentException");
//        } catch (IllegalArgumentException ex) {
//            assertEquals("data must not be null", ex.getMessage());
//        }
...
//            oneOf(data).getColumnCount(); will(returnValue(0));
//        }});
//        double result = calculateRowTotal(data, column, validRows);
//        assertEquals(0.0, result, 0.0);
//        context.assertIsSatisfied();
//    }
    
//    @Test
//    public void testZeroColumnRow() {
//        Mockery context = new Mockery();
//        final Values2D data = context.mock(Values2D.class);
//        final int column = 0;
//        final int[] validRows = {0, 1, 2};
//        context.checking(new Expectations() {{
//            oneOf(data).getColumnCount(); will(returnValue(3));
//            oneOf(data).getValue(0, 0); will(returnValue(1.0));
//            oneOf(data).getValue(1, 0); will(returnValue(2.0));
//            oneOf(data).getValue(2, 0); will(returnValue(3.0));
//        }});
...
//    
//    @Test
//    public void testMultipleRowDataRow() {
//        Mockery context = new Mockery();
//        final Values2D data = context.mock(Values2D.class);
//        final int column = 0;
//        final int[] validRows = {0, 2};
...
//            ignoring(data).getValue(1, 0);
//            oneOf(data).getValue(2, 0); will(returnValue(2.0));
//        }});
//        double result = calculateRowTotal(data, column, validRows);
//        assertEquals(4.0, result, 0.0);
//        context.assertIsSatisfied();
...
//        }});
//        try {
//            calculateRowTotal(data, row, validCols);
//            fail("Expected IllegalArgumentException");
//        } catch (IllegalArgumentException ex) {
//            assertEquals("data must not be null", ex.getMessage());
//        }
...
//    }
    ...
    public void testEmptyDataRow() {
        ...
        context.checking(new Expectations() {{
            oneOf(data).getColumnCount(); will(returnValue(3));
            oneOf(data).getValue(row, 0); will(returnValue(null));
            oneOf(data).getValue(row, 1); will(returnValue(null));
            oneOf(data).getValue(row, 2); will(returnValue(null));
        }});
        double result = calculateRowTotal(data, row, validCols);
        assertEquals(0.0, result, 0.0);
        context.assertIsSatisfied();
    }
    ...
    public void testZeroColumnRow() {
        ...
        final Values2D data = context.mock(Values2D.class);
        final int row = 0;
        final int[] validCols = {0};
        context.checking(new Expectations() {{
            oneOf(data).getColumnCount(); will(returnValue(3));
            oneOf(data).getValue(row, 0); will(returnValue(1.0));
        }});
        double result = calculateRowTotal(data, row, validCols);
    ...
    @Test
    public void testMultipleColumnData() {
        Mockery context = new Mockery();
        final Values2D data = context.mock(Values2D.class);
        final int row = 1;
        final int[] validCols = {0, 2};
        context.checking(new Expectations() {{
            oneOf(data).getColumnCount(); will(returnValue(3));
            ignoring(data).getValue(row, 0);
            oneOf(data).getValue(row, 2); will(returnValue(3.0));
        }});
        double result = calculateRowTotal(data, row, validCols);
